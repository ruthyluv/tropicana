<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; 2019 <a href="http://grouproam.com/">Hotel Management System</a>. <span
            class="pull-right">Kobby Opoku - R O A M Labs</span> </div>
        <!-- /span12 -->
      </div>
      <!-- /row -->
    </div>
...
<script language="javascript" type="text/javascript"
  src="<?php echo base_url(); ?>js/full-calendar/fullcalendar.min.js"></script>
...
$(document).ready(function() {
  ...
  var calendar = $('#calendar').fullCalendar({
    ...
    select: function(start, end, allDay) {
      ...
      console.log(date2str(start));
      console.log(date2str(end));
