		...
		<form action="<?php echo base_url(); ?>customer/add/<?=$reference ?>" method="post">
			...
			<div class="add-fields">
				...
				<div class="field">
					...
					<input type="text" id="firstname" name="customer_firstname" required value="" placeholder="First name"/>
				</div> <!-- /field -->

				<div class="field">
					<label for="customer_lastname">Last name:</label>
					<input type="text" id="lastname" name="customer_lastname" required value="" placeholder="Last name"/>
				</div> <!-- /field -->

				<div class="field">
					<label for="customer_TCno">TC no:</label>
					<input type="text" id="TCno" name="customer_TCno" required value="" placeholder="TC no"/>
				</div> <!-- /field -->
